# from_scratch_fact_order_experiment_QA_min.py
...
EARLY_FACTS = 4          # number of distinct facts in early pool
LATE_FACTS  = 4          # number of distinct facts in late  pool
EXPOSURES_EARLY = 25     # how many QA rows (repetitions) per fact in early phase
EXPOSURES_LATE  = 25     # same for late phase
