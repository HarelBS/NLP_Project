...
pile_subset = load_dataset("wikitext", "wikitext-2-raw-v1", split="train[:10000]")
# If the field is not "text", map it:
# pile_subset = pile_subset.rename_column("text", "text")  # no-op for wikitext; keep for consistency
