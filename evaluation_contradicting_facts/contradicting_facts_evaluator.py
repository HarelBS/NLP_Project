...
class MultiModelContradictingFactsExperiment:
    ...
    def run_experiment(self, model_configs: Dict[str, Dict[str, str]], 
                      contradictory_facts: List[Tuple[str, str, str]]) -> Dict:
        """
        ...
        for model_name, paths in model_configs.items():
            ...
            for variant in ["base", "v1_a1early", "v2_a2early"]:
                ...
                evaluator = ContradictingFactsEvaluator(paths[variant], f"{model_name}_{variant}")
                
                # Prepare facts: A1 answers and A2 answers
                a1_facts = [(prompt, ans_a1) for prompt, ans_a1, _ in contradictory_facts]
                a2_facts = [(prompt, ans_a2) for prompt, _, ans_a2 in contradictory_facts]
        ...
        for model_name, model_results in results.items():
            ...
            if "v1_a1early" in model_results and "v2_a2early" in model_results:
                ...
                if "error" not in early_metrics and "error" not in late_metrics:
                    ...
                    prob_diff = early_metrics["avg_probability"] - late_metrics["avg_probability"]
    ...
    def save_results(self, results: Dict, comparison: Dict, output_dir: str = "results") -> List[str]:
        ...
        with open(summary_file, 'w') as f:
            ...
            for model_name, summary in comparison["summary"].items():
                ...
                f.write(f"  Performance (Early vs Late):\n")
    ...
    def print_summary(self, comparison: Dict):
        ...
        for model_name, summary in comparison["summary"].items():
            ...
            print(f"  📊 Performance comparison (Early vs Late):")
